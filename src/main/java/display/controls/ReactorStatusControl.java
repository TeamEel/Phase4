 ...
 * @author James
 */
public class ReactorStatusControl implements Control,Observer {
...
private PlantController controller;
    ...
    public ReactorStatusControl(PlantController controller, PlantStatus status, Observable plant,   int x, int y) {
        this.controller = controller;
        this.status = status;
        this.plant = plant;
        this.x= x;
        this.y = y;
        this.text = new DrawableText("Reactor Pressure: " + status.reactorPressure().inAtmospheres()+ " atm",new Font("Arial", Font.BOLD, 14),Color.orange);
    ...
    public void update(Observable o, Object o1) {
        this.text.setText("Reactor Pressure: " + status.reactorPressure().inAtmospheres()+ " atm");
    }
